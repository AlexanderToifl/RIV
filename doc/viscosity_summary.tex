...
In \cite{Mayr2005} wird einfach eine zufällig orientierte Geschwindigkeit (entspricht der gewünschen Recoil-Energie) zufällig ausgewählten Atomen zugewiesen. Dabei werden unterschiedliche Randbedingungen verwendet (periodisch in alle Richtungen, periodisch in x,y und offen in z) um den Einfluss von Oberflächeneffekten zu berücksichtigen. Die 3 äußeren Lagen der Simulationsbox wurden Temperaturgeregelt und pro eV kinetischer Energie wurden 25 Atome simuliert um unerwünschtes Aufheizen zu vermeiden. 
