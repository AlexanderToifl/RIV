...
\begin{itemize}
	\item Definition der dynamischen Viskosität
	      ...
	      \end{equation}
	      $\tau$ ... Schubspannung
	      $\dot{\gamma} $ ... Geschwindigkeitsprofil senkrecht zur Bewegungsrichtung
...
\subsection{Reverse Non-Equlibirium MD  (rNEMD) Simulationen}
	\begin{itemize}
		 \item Zusammenfassende Beschreibung in \cite{Tenney2010}:
		  ...
		  \item Vorgabe der Schergeschwindigkeit: \textbf{Periodischer} Tausch von Impulsen (momenta swaps) 
		  		\begin{itemize}
